...
return [
    'trap_handlers' => [
        ...
        'CISCO-CONFIG-MAN-MIB::ccmCLIRunningConfigChanged' => LibreNMS\Snmptrap\Handlers\CiscoCCMCLIRunningConfigChanged::class,
        'CISCO-IF-EXTENSION-MIB::cieLinkDown' => LibreNMS\Snmptrap\Handlers\CieLinkDown::class,
        'CISCO-IF-EXTENSION-MIB::cieLinkUp' => LibreNMS\Snmptrap\Handlers\CieLinkUp::class,
        'CISCO-SYSLOG-MIB::clogMessageGenerated' => LibreNMS\Snmptrap\Handlers\CiscoClogMessageGenerated::class,
        ...
        'CISCO-NS-MIB::fcNameServerDatabaseFull' => LibreNMS\Snmptrap\Handlers\CiscoNSDatabaseFull::class,
        'CISCO-NS-MIB::fcNameServerEntryAdd' => LibreNMS\Snmptrap\Handlers\CiscoNSEntryAdd::class,
        'CISCO-NS-MIB::fcNameServerEntryDelete' => LibreNMS\Snmptrap\Handlers\CiscoNSEntryDelete::class,
        'CISCO-NS-MIB::fcNameServerRejectRegNotify' => LibreNMS\Snmptrap\Handlers\CiscoNSRejectRegNotify::class,
        'CISCO-UNIFIED-COMPUTING-MIB::cucsFaultActiveNotif' => LibreNMS\Snmptrap\Handlers\CiscoUnifiedComputingCucsFaultActiveNotif::class,
        'CISCO-UNIFIED-COMPUTING-MIB::cucsFaultClearNotif' => LibreNMS\Snmptrap\Handlers\CiscoUnifiedComputingCucsFaultClearNotif::class,
        ...
        'CPPM-MIB::cppmServiceStopNotification' => LibreNMS\Snmptrap\Handlers\CppmServiceStopNotification::class,
        'CPPM-MIB::cppmServiceStartNotification' => LibreNMS\Snmptrap\Handlers\CppmServiceStartNotification::class,
        'CPPM-MIB::cppmServiceRestartNotification' => LibreNMS\Snmptrap\Handlers\CppmServiceRestartNotification::class,
        ...
        'POSEIDON-MIB::sensAlarmStateChanged' => LibreNMS\Snmptrap\Handlers\PoseidonSensAlarmStateChanged::class,
        'POSEIDON-MIB::tsTrapAlarmEnd' => LibreNMS\Snmptrap\Handlers\PoseidonTsTrapAlarmEnd::class,
        'POSEIDON-MIB::tsTrapAlarmStart' => LibreNMS\Snmptrap\Handlers\PoseidonTsTrapAlarmStart::class,
        ...
        'PowerNet-MIB::lowBattery' => LibreNMS\Snmptrap\Handlers\ApcLowBattery::class,
